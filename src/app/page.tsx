    ...
    <>
      ...
      <section className='relative flex min-h-screen flex-col justify-center overflow-hidden px-6 pb-16 pt-24 sm:px-10'>
        ...
        <div className='relative z-10 w-full max-w-2xl'>
          <p className='mb-3 text-xs font-bold tracking-[0.3em] text-text-muted sm:text-sm'>
            UNOFFICIAL FAN SITE
          </p>
          <h1 className='font-heavy text-[clamp(2.75rem,13vw,7rem)] leading-[0.95] tracking-[-0.03em]'>
            CAFE
            <br />
            CARTE
          </h1>
          <p className='mt-5 max-w-md text-sm text-text-muted sm:text-base'>
